...
const translations = {
  en: {
    ...
    'login.manageFinances': 'Manage your finances seamlessly.',
    'login.accessDashboard': 'Access your dashboard to track spending, manage cards, and send money instantly worldwide.',
    'login.invalidCredentials': 'Invalid email or password',

    // Register page
    'register.title': 'Open your account',
    'register.subtitle': 'Join thousands of happy customers in under 5 minutes',
    'register.step1.title': 'Personal Info',
    'register.step2.title': 'Contact Details',
    'register.step3.title': 'Financial Profile',
    'register.step4.title': 'Security',
    'register.fullName': 'Full Name',
    'register.fullNamePlaceholder': 'John Doe',
    'register.dateOfBirth': 'Date of Birth',
    'register.idNumber': 'ID Number / Passport',
    'register.idNumberPlaceholder': 'ABC123456',
    'register.email': 'Email Address',
    'register.phone': 'Phone Number',
    'register.address': 'Address',
    'register.city': 'City',
    'register.cityPlaceholder': 'New York',
    'register.postalCode': 'Postal Code',
    'register.employmentStatus': 'Employment Status',
    'register.selectStatus': 'Select status',
    'register.employed': 'Employed Full-time',
    'register.selfEmployed': 'Self-employed',
    'register.partTime': 'Employed Part-time',
    'register.student': 'Student',
    'register.retired': 'Retired',
    'register.other': 'Other',
    'register.annualIncome': 'Annual Income Range',
    'register.selectRange': 'Select range',
    'register.quickTip': 'Quick Tip',
    'register.quickTipText': 'Providing accurate financial information helps us recommend the best card for your needs.',
    'register.password': 'Password',
    'register.passwordHint': 'Must be at least 8 characters with 1 number and 1 special character',
    'register.confirmPassword': 'Confirm Password',
    'register.agreeToTerms': 'I agree to the',
    'register.termsOfService': 'Terms of Service',
    'register.and': 'and',
    'register.privacyPolicy': 'Privacy Policy',
    'register.encryption': 'Your information is protected with 256-bit encryption',
  ...
  pt: {
    ...
    'login.enterDetails': 'Insira seus dados para acessar sua conta.',
    'login.emailAddress': 'Endereço de Email',
    'login.password': 'Senha',
    'login.forgotPassword': 'Esqueceu a senha?',
    'login.rememberMe': 'Lembrar-me por 30 dias',
    'login.signIn': 'Entrar',
    'login.signingIn': 'Entrando...',
    'login.noAccount': 'Não tem uma conta?',
    'login.signUp': 'Cadastre-se grátis',
    'login.manageFinances': 'Gerencie suas finanças sem complicações.',
    'login.accessDashboard': 'Acesse seu painel para acompanhar gastos, gerenciar cartões e enviar dinheiro instantaneamente para todo o mundo.',
    'login.invalidCredentials': 'Email ou senha inválidos',

    // Register page
    'register.title': 'Abra sua conta',
    'register.subtitle': 'Junte-se a milhares de clientes satisfeitos em menos de 5 minutos',
    'register.step1.title': 'Dados Pessoais',
    'register.step2.title': 'Contato',
    'register.step3.title': 'Perfil Financeiro',
    'register.step4.title': 'Segurança',
    'register.fullName': 'Nome Completo',
    'register.fullNamePlaceholder': 'João Silva',
    'register.dateOfBirth': 'Data de Nascimento',
    'register.idNumber': 'Número do RG / Passaporte',
    'register.idNumberPlaceholder': '12.345.678-9',
    'register.email': 'Endereço de Email',
    'register.phone': 'Telefone',
    'register.address': 'Endereço',
    'register.city': 'Cidade',
    'register.cityPlaceholder': 'São Paulo',
    'register.postalCode': 'CEP',
    'register.employmentStatus': 'Situação Profissional',
    'register.selectStatus': 'Selecione',
    'register.employed': 'CLT',
    'register.selfEmployed': 'Autônomo',
    'register.partTime': 'Meio Período',
    'register.student': 'Estudante',
    'register.retired': 'Aposentado',
    'register.other': 'Outro',
    'register.annualIncome': 'Renda Anual',
    'register.selectRange': 'Selecione a faixa',
    'register.quickTip': 'Dica Rápida',
    'register.quickTipText': 'Fornecer informações precisas nos ajuda a recomendar o melhor cartão para você.',
    'register.password': 'Senha',
    'register.passwordHint': 'Mínimo de 8 caracteres, incluindo 1 número e 1 caractere especial',
    'register.confirmPassword': 'Confirmar Senha',
    'register.agreeToTerms': 'Eu concordo com os',
    'register.termsOfService': 'Termos de Serviço',
    'register.and': 'e',
    'register.privacyPolicy': 'Política de Privacidade',
    'register.encryption': 'Suas informações são protegidas com criptografia de 256 bits',
    'register.previous': 'Anterior',
    'register.nextStep': 'Próximo',
