              ...
              <div className="flex justify-between mt-8 pt-6 border-t border-zinc-100">
                {step > 1 ? (
                  <motion.button
                    ...
                    type="button"
                    onClick={prevStep}
                    className="flex items-center gap-2 px-6 py-3 bg-zinc-100 text-zinc-600 rounded-xl font-bold hover:bg-zinc-200 transition-colors"
                  >
                    <ChevronLeft size={18} />
                    {t('register.previous')}
                  </motion.button>
                ...
                {step < 4 ? (
                  <motion.button
                    ...
                    type="button"
                    onClick={nextStep}
                    className="flex items-center gap-2 px-8 py-3 bg-black text-white rounded-xl font-bold hover:bg-zinc-800 transition-colors shadow-xl shadow-black/10"
                  >
                    {t('register.nextStep')}
